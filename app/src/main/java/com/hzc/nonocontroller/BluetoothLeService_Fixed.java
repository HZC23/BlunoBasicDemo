 ...
 */
public class BluetoothLeService_Fixed extends Service {
    private final static String TAG = BluetoothLeService_Fixed.class.getSimpleName();
...
//        }
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeService_Fixed getService() {
            return BluetoothLeService_Fixed.this;
        }
    }
